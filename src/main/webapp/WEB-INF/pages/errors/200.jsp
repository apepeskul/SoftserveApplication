       ...
       <div class="row">
           <div class="span12">
               <div class="hero-unit center">
                   <h1>Successful <small><font face="Tahoma" color="red">200 Successful</font></small></h1>
                   <br />
                   <p>The client's request was successfully processed and the server's response contains the requested data.
